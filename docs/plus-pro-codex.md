# ChatGPT Plus / Pro / Codex 选择清单

更新时间：2026-06-14

## 选择原则

先按真实任务选，不要只按价格或别人推荐选。日常聊天、写作、图片和轻度办公先看 Plus；高频研究、开发、数据分析和长时间使用再看 Pro；主要为了代码生成、代码审查和项目工作流再单独核对 Codex。

## 对比表

| 场景 | Plus | Pro | Codex |
| --- | --- | --- | --- |
| 日常聊天和写作 | 优先考虑 | 通常不是第一选择 | 不适合单独为此购买 |
| 图片、文件和轻度办公 | 优先考虑 | 看额度和预算 | 不适合单独为此购买 |
| 高频研究和长时间使用 | 可能不够 | 优先考虑 | 只在代码任务相关时考虑 |
