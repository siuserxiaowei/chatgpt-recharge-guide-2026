...
| 路径 | 适合谁 | 主要核对项 |
| --- | --- | --- |
| 海外卡 | 已有可用卡和账单地址的人 | 卡片地区、续费、失败记录 |
| 虚拟卡 | 愿意自己维护卡片和余额的人 | 开卡费、KYC、汇率、失败处理 |
| 礼品卡 | 熟悉地区和兑换规则的人 | 地区、余额、兑换限制 |
| USDT | 熟悉链上转账的人 | 网络、txid、金额、订单对应 |
| 独立商城代办 | 希望集中看商品、订单和售后的人 | 商品说明、订单查询、付款凭证、售后边界 |

## 付款前要确认

1. 当前商品页是否写清楚权益和价格。
2. 订单金额和付款金额是否一致。
3. 支付宝、微信或 USDT 是否能留下完整凭证。
4. 订单是否能用订单号和查单密码查询。
5. 异常时是否有服务条款和售后边界。
